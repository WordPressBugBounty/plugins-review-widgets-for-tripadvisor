...
"showLines": 2,
"lessText": "'. esc_html(__('Show less', 'review-widgets-for-tripadvisor')) .'",
"moreText": "'. esc_html(__('Show more', 'review-widgets-for-tripadvisor')) .'",
});
...
?>
<div class="ti-header-title"><?php echo esc_html(__('My Reviews', 'review-widgets-for-tripadvisor')); ?></div>
<div class="ti-box">
<?php if (!$isReviewDownloadInProgress): ?>
<?php if ($reviewDownloadFailed): ?>
<div class="ti-notice ti-notice-error">
<p><?php echo esc_html(__('The manual review download not available yet.', 'review-widgets-for-tripadvisor')); ?></p>
</div>
<?php endif; ?>
...
<?php echo esc_html(__('Download new reviews', 'review-widgets-for-tripadvisor'));?>
<span class="ti-tooltip-message"><?php echo esc_html(__('Now, you can download your new reviews.', 'review-widgets-for-tripadvisor')); ?></span>
</a>
<?php else: ?>
...
/* translators: %d: days */
echo esc_html(sprintf(__('The manual review download will be available again in %d day(s).', 'review-widgets-for-tripadvisor'), $days));
?></span>
</a>
<?php endif; ?>
...
<strong><?php echo esc_html(__('UPGRADE to PRO Features', 'review-widgets-for-tripadvisor')); ?></strong>
<p><?php
/* translators: %d: platform number */
echo esc_html(sprintf(__('Automatic review update, creating unlimited review widgets, downloading and displaying all reviews, %d review platforms available!', 'review-widgets-for-tripadvisor'), 137));
?></p>
<?php echo wp_kses_post($pluginManagerInstance->getProFeatureButton('wp-tripadvisor-pro')); ?>
</div>

<?php if ($isReviewDownloadInProgress === 'error'): ?>
<div class="ti-notice ti-mb-1 ti-notice-error">
<p>
<?php echo esc_html(__('While downloading the reviews, we noticed that your connected page is not found.<br />If it really exists, please contact us to resolve the issue or try connect it again.', 'review-widgets-for-tripadvisor')); ?><br />
</p>
</div>
...
<p><?php echo esc_html(__('You had no reviews at the time of last review downloading.', 'review-widgets-for-tripadvisor')); ?></p>
</div>
<?php endif; ?>
<?php else: ?>
...
<thead>
<tr>
<th class="ti-text-center"><?php echo esc_html(__('Reviewer', 'review-widgets-for-tripadvisor')); ?></th>
<th class="ti-text-center" style="width: 90px;"><?php echo esc_html(__('Rating', 'review-widgets-for-tripadvisor')); ?></th>
<th class="ti-text-center"><?php echo esc_html(__('Date', 'review-widgets-for-tripadvisor')); ?></th>
<th style="width: 50%"><?php echo esc_html(__('Text', 'review-widgets-for-tripadvisor')); ?></th>
</tr>
</thead>
<tbody>
...
<td class="ti-text-center source-<?php echo esc_attr(ucfirst("tripadvisor")); ?>"><?php echo wp_kses_post(trustindex_plugin_write_rating_stars($review->rating)); ?></td>
...
<?php if ($review->reply): ?>
<a href="#" class="ti-btn ti-btn-default ti-btn-sm ti-btn-default-disabled btn-show-ai-reply"><?php echo esc_html(__('Reply', 'review-widgets-for-tripadvisor')); ?></a>
<?php else: ?>
<a href="#" class="ti-btn ti-btn-sm btn-show-ai-reply" data-edit-reply-text="<?php echo esc_html(__('Reply', 'review-widgets-for-tripadvisor')); ?>"><?php echo esc_html(__('Reply with ChatGPT', 'review-widgets-for-tripadvisor')); ?></a>
<?php endif; ?>
<?php endif; ?>
<?php if ($review->text): ?>
<a href="<?php echo esc_attr($review->id); ?>" class="ti-btn ti-btn-sm ti-btn-default btn-show-highlight<?php if (isset($review->highlight) && $review->highlight): ?> has-highlight<?php endif; ?>"><?php echo esc_html(__('Highlight text', 'review-widgets-for-tripadvisor')) ;?></a>
<?php endif; ?>
<?php endif; ?>
...
<?php if (!$review->hidden): ?>
<?php echo esc_html(__('Hide review', 'review-widgets-for-tripadvisor')); ?>
<?php else: ?>
<?php echo esc_html(__('Show review', 'review-widgets-for-tripadvisor')); ?>
<?php endif; ?>
</a>
...
<strong><?php echo esc_html(__('ChatGPT generated reply', 'review-widgets-for-tripadvisor')); ?></strong>
<span><?php echo esc_html(__('you can modify before upload', 'review-widgets-for-tripadvisor')); ?>
</div>
<textarea id="ti-ai-reply-<?php echo esc_attr($review->id); ?>" rows="1"></textarea>
<?php if (!$review->text): ?>
<div class="ti-alert ti-alert-empty-review d-none"><?php echo esc_html(__("The reply was generated in your widget language because the review's text is empty.", 'review-widgets-for-tripadvisor')); ?></div>
<?php endif; ?>
...
echo esc_html(sprintf(__('Upload reply to %s', 'review-widgets-for-tripadvisor'), 'Tripadvisor'));
?></a>
<a href="#" class="ti-btn ti-btn-sm ti-btn-no-background btn-hide-ai-reply"><?php echo esc_html(__('Cancel', 'review-widgets-for-tripadvisor')); ?></a>
</div>
...
<div class="ti-button-dropdown-title">
<strong><?php echo esc_html(__('Copy the reply', 'review-widgets-for-tripadvisor')); ?></strong>
</div>
<div class="ti-alert ti-alert-warning ti-d-none">
<?php echo esc_html(__('We could not connect your account with the review.', 'review-widgets-for-tripadvisor')); ?>
<a href="#" class="btn-try-reply-again"><?php echo esc_html(__('Try again', 'review-widgets-for-tripadvisor')); ?></a>
</div>
...
<div class="ti-button-dropdown-title">
<strong><?php echo esc_html(__('Highlight text', 'review-widgets-for-tripadvisor')); ?></strong>
<span><?php echo esc_html(__('just select the text you want to highlight', 'review-widgets-for-tripadvisor')); ?>
</div>
...
<a href="<?php echo esc_attr($review->id); ?>" data-nonce="<?php echo esc_attr(wp_create_nonce('ti-save-highlight')); ?>" class="ti-btn ti-btn-sm btn-save-highlight"><?php echo esc_html(__('Save', 'review-widgets-for-tripadvisor')); ?></a>
<a href="#" class="ti-btn ti-btn-sm ti-btn-no-background btn-hide-highlight"><?php echo esc_html(__('Cancel', 'review-widgets-for-tripadvisor')); ?></a>
<?php if ($review->highlight): ?>
<a href="<?php echo esc_attr($review->id); ?>" data-nonce="<?php echo esc_attr(wp_create_nonce('ti-save-highlight')); ?>" class="ti-btn ti-btn-sm ti-btn-danger ti-pull-right btn-remove-highlight"><?php echo esc_html(__('Remove highlight', 'review-widgets-for-tripadvisor')); ?></a>
<?php endif; ?>
</div>
<?php endif; ?>
</td>
...
<?php endif; ?>
<?php
$tiCampaign1 = 'wp-tripadvisor-4';
$tiCampaign2 = 'wp-tripadvisor-5';
