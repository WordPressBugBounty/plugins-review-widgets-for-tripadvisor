...
<?php echo $pluginManagerInstance->getProFeatureButton('wp-tripadvisor-pro'); ?>
</div>
...
<td class="ti-text-center source-<?php echo ucfirst("tripadvisor") ?>"><?php echo trustindex_plugin_write_rating_stars($review->rating); ?></td>
...
<?php endif; ?>
<a href="<?php echo esc_attr($review->id); ?>" data-nonce="<?php echo wp_create_nonce('ti-save-reply'); ?>" class="ti-btn ti-btn-sm btn-post-reply"><?php echo sprintf(__('Upload reply to %s', 'trustindex-plugin'), 'Tripadvisor'); ?></a>
