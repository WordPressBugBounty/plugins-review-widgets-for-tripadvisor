...
$stepList = [
sprintf(__('Connect %s', 'trustindex-plugin'), 'Tripadvisor'),
...
<h1 class="ti-header-title"><?php echo sprintf(__('Connect %s', 'trustindex-plugin'), 'Tripadvisor'); ?></h1>
...
$labelText = sprintf(__('%s Business URL', 'trustindex-plugin'), 'Tripadvisor');
$infoText = __("Type your business/company's URL and select from the list", 'trustindex-plugin');
$errorText = sprintf(__('Please add your URL again: this is not a valid %s page.', 'trustindex-plugin'), "Tripadvisor");
...
<?php endif; ?>
<h1 class="ti-header-title ti-mt-2"><?php echo sprintf(__('Check some %s widget layouts and styles', 'trustindex-plugin'), 'Tripadvisor reviews'); ?></h1>
...
<p>
<?php echo sprintf(__('There are no reviews on your %s platform.', 'trustindex-plugin'), 'Tripadvisor'); ?>
</p>
</div>
<?php endif; ?>
