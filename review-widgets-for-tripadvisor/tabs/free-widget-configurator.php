...
echo wp_kses_post(sprintf(__("You have connected your Trustindex account, so you can find premium functionality under the %s tab. You no longer need this tab unless you choose the limited but forever free mode.", 'review-widgets-for-tripadvisor'), $advancedTab));
?>
</p>
</div>
<?php endif; ?>
