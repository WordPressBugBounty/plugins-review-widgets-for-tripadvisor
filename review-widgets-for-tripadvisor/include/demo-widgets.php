...
<?php echo esc_html(__('Example Widget', 'review-widgets-for-tripadvisor')); ?>:
...
<div class="preview"><?php echo wp_kses($pluginManagerInstance->renderWidgetFrontend('4d1942c1993d76d394824aa58'), $pluginManager::$allowedAttributesForWidget); ?></div>
</div>
</div>
</div>
<?php
