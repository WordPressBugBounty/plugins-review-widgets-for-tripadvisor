<?php
namespace Elementor;
use TrustindexPlugin_Tripadvisor;
use Elementor\Widget_Base;
defined('ABSPATH') or die('No script kiddies please!');
class TrustrindexElementorWidget_Tripadvisor extends Widget_Base {
...
return $this->platformName .' '. __('Reviews', 'review-widgets-for-tripadvisor') . ' - Trustindex';
}
...
{
$this->start_controls_section('content_section', [ 'label' => __('Widget type', 'review-widgets-for-tripadvisor') ]);
...
'title' => '',
'icon' => '',
'label' => ucfirst(__('free', 'review-widgets-for-tripadvisor')) . ' widget',
],
'pro' => [
'title' => '',
'icon' => '',
...
'notice_type' => 'success',
'heading' => __('UPGRADE to PRO Features', 'review-widgets-for-tripadvisor'),
/* translators: %d: number */
'content' => sprintf(__('Automatic review update, creating unlimited review widgets, downloading and displaying all reviews, %d review platforms available!', 'review-widgets-for-tripadvisor'), 137)
. '<br /><br /><a href="https://www.trustindex.io/?a=sys&c=wp-google-elementor" target="_blank">'.__('Create a Free Account for More Features', 'review-widgets-for-tripadvisor').'</a>',
'condition' => [ 'type' => 'free' ],
]);
}
...
'placeholder' => sprintf(__('Paste the widget shortcode from the Advanced Widget Editor on the %s.', 'review-widgets-for-tripadvisor'), 'admin.trusintdex.io'),
'label_block' => true,
'condition' => [ 'type' => 'pro' ],
]);
