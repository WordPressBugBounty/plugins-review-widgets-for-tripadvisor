...
$trustindex_pm_tripadvisor = new TrustindexPlugin_tripadvisor("tripadvisor", __FILE__, "13.1", "WP Tripadvisor Review Widgets", "Tripadvisor");
...
<p>
<a href="<?php echo admin_url("admin.php?page=review-widgets-for-tripadvisor/settings.php&wc_notification=open"); ?>" target="_blank" class="ti-close-notification" style="text-decoration: none">
<button class="button button-primary"><?php echo __('Download plugin', 'trustindex-plugin'); ?></button>
</a>
<a href="<?php echo admin_url("admin.php?page=review-widgets-for-tripadvisor/settings.php&wc_notification=hide"); ?>"target="_blank" class="ti-hide-notification" style="text-decoration: none">
